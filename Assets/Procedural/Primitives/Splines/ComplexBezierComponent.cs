...
{
    public class ComplexBezierComponent : MonoBehaviour, ISpline
    {
        ...
        public List<Bezier.ControlPoint> points = new List<Bezier.ControlPoint>(new Bezier.ControlPoint[]{
