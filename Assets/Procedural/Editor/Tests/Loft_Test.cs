...
namespace Procedural.Test
{
    ...
    internal class Loft_Test
    {
        ...
        public void SurfacePositionTest()
        {
            ...
            UAssert.Near(torus.SurfacePoint(0.5f, 0.0f), new Vector3(0.0f, -1.25f, 0.0f), 0.01f);

            // Sample around the shape
            UAssert.Near(torus.SurfacePoint(0.0f, 0.5f), new Vector3(0.0f, 1.25f, 0.0f), 0.01f);
